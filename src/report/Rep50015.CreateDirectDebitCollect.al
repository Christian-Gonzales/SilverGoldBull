report 50015 "Create Direct Debit Collect."
{
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                field(BankCurrCode; BankAccount."Currency Code")
                {
                    ApplicationArea = Suite;
                    Caption = 'Currency Code';
                    Editable = false;
                    Enabled = false;
                    ToolTip = 'Specifies the currency of the bank account that you select in the Bank Account No. field. This field is filled automatically.';
                }
