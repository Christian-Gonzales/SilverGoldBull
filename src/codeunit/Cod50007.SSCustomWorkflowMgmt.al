codeunit 50007 "SS Custom Workflow Mgmt"
{
    ...
    begin
        ...
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONSENDFORAPPROVALCODE, RecRef), Database::"G/L Account",
          GetWorkflowEventDesc(WorkflowSendForApprovalEventDescTxt, RecRef), 0, false);
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONCANCELFORAPPROVALCODE, RecRef), DATABASE::"G/L Account",
          GetWorkflowEventDesc(WorkflowCancelForApprovalEventDescTxt, RecRef), 0, false);
    end;
    // subscribe

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"SS Custom Workflow Mgmt", 'OnSendWorkflowForApproval', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"SS Custom Workflow Mgmt", 'OnCancelWorkflowForApproval', '', false, false)]
    ...
    var
        CustomWorkflowHdr: Record "G/L Account";
    begin
        case RecRef.Number of
            Database::"G/L Account":
                begin
                    ...
                    CustomWorkflowHdr.Blocked := true;
        ...
        case RecRef.Number of
            DataBase::"G/L Account":
                begin
                    ...
                    CustomWorkflowHdr.Blocked := false;
                    CustomWorkflowHdr.Modify(true);
                    Handled := true;
                end;
        end;
